...
const manifest = {
  ...
  routes: [
    ...
    },
    {
      ...
      pattern: /^\/todos\.json$/,
      params: empty,
      load: () => import("./index.json-5f3b87c3.js")
    },
    {
      type: "page",
      pattern: /^\/todos\/?$/,
    ...
    },
    {
      ...
      pattern: /^\/todos\/([^/]+?)\.json$/,
      params: (m) => ({ uid: d(m[1]) }),
      load: () => import("./_uid_.json-18821520.js")
    }
  ]
};
...
const module_lookup = {
  "src/routes/__layout.svelte": () => import("./__layout-49160df2.js"),
  ".svelte-kit/build/components/error.svelte": () => import("./error-8eee382b.js"),
  "src/routes/index.svelte": () => import("./index-14634b1e.js"),
  "src/routes/about.svelte": () => import("./about-0d75998b.js"),
  "src/routes/todos/index.svelte": () => import("./index-84108f15.js")
};
...
export { compute_rest_props as a, createEventDispatcher as b, create_ssr_component as c, spread as d, escape_attribute_value as e, escape_object as f, add_attribute as g, escape as h, setContext as i, getContext as j, subscribe as k, each as l, init as m, noop as n, onDestroy as o, render as r, safe_not_equal as s, validate_component as v };
